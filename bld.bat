...
node ..\TW5\tiddlywiki.js --recipe empty.html.recipe --savewiki %DEST%
del %DEST%\empty.html 2> NUL & ren %DEST%\index.html empty.html
echo BUILD: assembling INDEX.HTML
node ..\TW5\tiddlywiki.js --recipe index.html.recipe --savewiki %DEST%
